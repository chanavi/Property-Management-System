                ...
                <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
                    ...
                    <div class="collapse navbar-collapse" id="expandme">
                        <div class="navbar-nav">
                            <div class="btn-group">
                                <button class="btn"><a href="home_login.html"
                                        class="nav-item nav-link">Home</a></button>
                                ...
                                <button class="btn"><a href="sellrent.html" class="nav-item nav-link">Rent
                                        Out</a></button>
                                <button class="btn"><a href="brokerlogin.html"
                                        class="nav-item nav-link">Broker</a></button>
                                <button class="btn"><a href="property_services.html"
                                        class="nav-item nav-link">Services</a></button>
                                <button class="btn"><a href="about_us.html" class="nav-item nav-link">About
                                        Us</a></button>
                ...
                <div class="row">
                    <div class=".col-6 mx-auto">
                        <p class="main-btns">
                            ...
                            <a href="#prop" class="mainbtn btn btn-outline-dark btn-lg my-2" onclick="rentProp();">Rent
                                In</a>
                        </p>
                    </div>
                </div>
        ...
        <div id="prop" class="album py-5 bg-light invisible">
            <div class="container">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-dark invisible" type="button" id="button-addon1"
                        onclick="clearLocation();">X</button>
                    <button class="btn btn-outline-dark" type="button" id="button-addon2"
                        onclick="locate();">Search</button>
                </div>
