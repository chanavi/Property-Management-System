  ...
  <main>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
          ...
          <div class="collapse navbar-collapse" id="expandme">
            <div class="navbar-nav">
              <div class="btn-group">
                <button class="btn"><a href="" class="nav-item nav-link">Home</a></button>
                <button class="btn"><a href="" class="nav-item nav-link active">Buy</a></button>
                <button class="btn"><a href="" class="nav-item nav-link">Sell</a></button>
                <button class="btn"><a href="" class="nav-item nav-link">Services</a></button>
              </div>
            </div>
          </div>
        </nav>
    ...
    <div id="prop" class="album py-5 bg-light invisible">
      <div class="container">
        ...
        <?php
    		$conn = mysqli_connect("localhost:3307", "root", "chakshu7", "miniproject");
    // Check connection
